...
/*    void flip() {
    ...
    public void moveSelected(){
        ...
        if(this.isFlipped && this.isSelected){
            TranslateTransition translateTransitionFront = new TranslateTransition(Duration.millis(100), front);
            translateTransitionFront.setToY(250);
            translateTransitionFront.play();
        }
    }
